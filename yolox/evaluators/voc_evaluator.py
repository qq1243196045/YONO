...
class VOCEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids,class_id) in enumerate(
            ...
            with torch.no_grad():
                ...
                outputs,x_fc = model(imgs)


                # print("the shape of outputs is ", outputs.shape) # 1,8400,26(21+5)
                pred, idx = torch.topk(x_fc,5,sorted=True,largest=True)

                # print("the shape of x_fc is ", x_fc.shape) # 1,21
