...
sumary_txt = open('/home/white/projects/python/YOLOX-double/sumery.txt','a+')
current_time = time.localtime()
current_time = time.strftime("%Y/%m/%d/%H", current_time)
sumary_txt.write("============================================")
sumary_txt.write('\n')
sumary_txt.write("summary data: {}".format(current_time))
sumary_txt.write('\n')
sumary_txt.write("============================================")
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        if not args.quiet:
            if len(prec)>0:
                ...
                sumary_txt.write(text + "\t||\tscore_threhold=0.5 : " + "F1=" + "{0:.2f}".format(F1[score05_idx])\
                    + " ; Recall=" + "{0:.2f}%".format(rec[score05_idx]*100) + " ; Precision=" + "{0:.2f}%".format(prec[score05_idx]*100))
                sumary_txt.write('\n')
            else:
                print(text + "\t||\tscore_threhold=0.5 : F1=0.00% ; Recall=0.00% ; Precision=0.00%")
                sumary_txt.write(text + "\t||\tscore_threhold=0.5 : F1=0.00% ; Recall=0.00% ; Precision=0.00%")
                sumary_txt.write('\n')
