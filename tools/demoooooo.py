...
def make_parser(image_path):
    ...
    parser.add_argument("-c", "--ckpt", default="/home/white/projects/python/YOLOX-double/tools/YOLOX_outputs/yolox_voc_s/last_epoch_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
...
if __name__ == "__main__":
    ...
    img_id = "006095"
    img_path = "/mnt/data/datasets/voc/VOC07+12/VOCdevkit/VOC2007/JPEGImages/" + img_id + ".jpg"
    img_path = "/home/white/files/video/test.avi"
