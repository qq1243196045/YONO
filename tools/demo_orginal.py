...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        ...
        result_image = predictor.visual(outputs[0], img_info, predictor.confthre,x_fc)
        if save_result:
...
def main(exp, args):
    ...
    print("vis folder is ",vis_folder)
    if args.trt:
        args.device = "gpu"
...
if __name__ == "__main__":
    # img_id = "001308"
    # img_path = "/home/bona/Documents/datasets/1716/VOCdevkit/VOC2007/JPEGImages/" + img_id + ".jpg"
    img_id = "010435"
    # img_path = "/mnt/data/datasets/BONA/VOCdevkit/VOC2007/JPEGImages/" + img_id + ".jpg"
    img_path = "/home/white/projects/python/video_12.avi"
    video_path = '/home/white/files/video/test.avi'
