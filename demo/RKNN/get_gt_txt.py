...
image_paths = open("/mnt/data/datasets/1716/VOCdevkitmon/VOC2007/ImageSets/Main/test.txt").read().strip().split()
...
for image_path in image_paths:
    ...
    with open("./input/ground-truth/"+image_id+".txt", "w") as new_f:
        ...
        root = ET.parse("/mnt/data/datasets/1716/VOCdevkitmon/VOC2007/Annotations/"+image_id+".xml").getroot()
